...
export function VariantA() {
  ...
  return (
    <div className="bg-[#0A0A1A] min-h-screen">
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-14 flex flex-wrap items-center justify-center gap-8 md:gap-12">
            {[
              { value: "50+", label: "agents ranked" },
              { value: "72.8%", label: "fail basic security" },
              { value: "Free", label: "embeddable trust badges" },
            ].map((stat) => (
      ...
      <PricingPreview />
      <FinalCta
        headline="Ready to battle-test your agent?"
        ctaText="Battle-Test Free"
      />
      <LandingFooter />
    </div>
  );
