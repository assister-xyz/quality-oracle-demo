          ...
          <div className="flex gap-3">
            ...
            <div className="flex flex-col gap-2">
              <Button
                ...
                className="bg-[#0E0E0C]/10 text-[#0E0E0C] border border-[#0E0E0C]/20 hover:bg-[#0E0E0C]/20"
              >
          ...
          {!isRunning ? (
            <>
              <Button
                ...
                className="bg-[#0E0E0C] text-white font-semibold hover:bg-[#6941C6]"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card className="bg-white border-[#E5E3E0]">
            <CardContent className="p-4">
              ...
              <div className="text-2xl font-bold font-mono text-[#DB5F94]">
                {completedItems.length > 0
                ...
                {item.status === "running" && (
                  <div className="mt-3 space-y-1.5">
                    ...
                    <div className="h-1 rounded-full bg-muted/50 overflow-hidden">
                      <div
                        className="h-full rounded-full bg-[#E2754D] transition-all duration-300"
                        style={{
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    <div className="flex gap-0.5">
                      {(
                        ...
                        <div
                          key={key}
                          className="flex-1 h-1 rounded-full bg-muted/30 overflow-hidden"
                          title={`${key}: ${val}`}
                        >
                          <div
